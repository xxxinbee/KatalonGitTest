...
WebUI.verifyTextPresent('Create Building', false)

WebUI.setText(findTestObject('Object Repository/Building/input__buildingId'), findTestData('Building').getValue('ID', 1))

WebUI.setText(findTestObject('Object Repository/Building/input__buildingName'), findTestData('Building').getValue('Name', 
        1))
