...
public class building {
	...
	public createBuilding(){
		...
		String idBuilding = 'GD' + faker.address().buildingNumber()
		...
		WebUI.setText(findTestObject('Object Repository/Building/input__buildingId'), idBuilding)
		WebUI.setText(findTestObject('Object Repository/Building/input__buildingName'), nameBuilding)
		GlobalVariable. = idBuilding
		GlobalVariable. = nameBuilding
